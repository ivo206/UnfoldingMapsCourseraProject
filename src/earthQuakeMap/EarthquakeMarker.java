...
public abstract class EarthquakeMarker extends CommonMarker implements Comparable<EarthquakeMarker>
{
	...
	/**Method uset for comparison of Earthqakes base on their magnitude, uses for sorting */
	@Override
	public int compareTo(EarthquakeMarker otherMarker)
	{
		
		return (((Float)this.getMagnitude()).compareTo((Float)otherMarker.getMagnitude()))*(-1);
	}
